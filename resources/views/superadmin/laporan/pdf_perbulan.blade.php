...
<body>
    ...
    <hr>
    <h3 style="text-align: center">LAPORAN DATA PERBULAN
    </h3>
    <br />
    Bulan : {{\Carbon\Carbon::createFromDate(null, $bulan, null)->translatedFormat('F')}} {{$tahun}}
    <table width="100%" border="1" cellpadding="5" cellspacing="0">
        ...
        <tr>
            ...
            <td>{{number_format($data->sum('jumlah'))}}</td>
        </tr>
    </table>
